...
-- | This class gives the character associated with a type-level Char.
-- There are instances of the class for every concrete literal: 'a', etc.
--
-- @since 4.12.0.0
...
-- | This type represents unknown type-level characters.
--
-- @since 4.12.0.0
...
someCharVal c     = withSChar SomeChar (SChar c) Proxy
...
-- | Comparison of type-level characters, as a function.
--
-- @since 4.12.0.0
type family CmpChar (m :: Char) (n :: Char) :: Ordering
...
-- | Conversion of type-level strings to type-level symbols.
--
-- @since 4.12.0.0
type family StringToSymbol (m :: String) :: Symbol

type family FromSymbol (m :: Symbol) :: a
type instance FromSymbol m = m
type instance FromSymbol m = SymbolToString m
